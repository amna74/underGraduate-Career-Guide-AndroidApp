...
public class NonEngActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_eng2);
        ...
        fragment= new NonEngHomeFragment();
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft =  fm.beginTransaction();
        ft.replace(R.id.NonEngframeLayout,fragment);
        ft.commit();
//
        navigationViewss.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem menuItem) {
                ...
                {
                    case R.id.Homes:
                        startActivity(new Intent(NonEngActivity2.this, HomeScreen.class));
                        drawerLayout.closeDrawer(GravityCompat.START);
                        break;

                    case R.id.Profile:
                        Toast.makeText(NonEngActivity2.this, "Profile", Toast.LENGTH_SHORT).show();
                        drawerLayout.closeDrawer(GravityCompat.START);
                        break;
                    ...
                    default:
                        Toast.makeText(NonEngActivity2.this, "Nothing", Toast.LENGTH_LONG).show();
